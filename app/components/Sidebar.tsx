...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    const navItems = [
      ...
      { href: '/templates', label: 'Templates', icon: DocumentTextIcon, iconSolid: DocumentTextIconSolid },
      { href: '/bulk-operations', label: 'Bulk Operations', icon: ArrowPathIcon, iconSolid: ArrowPathIconSolid },
      { href: '/export', label: 'Export', icon: ArrowDownTrayIcon, iconSolid: ArrowDownTrayIconSolid },
      ...
      { href: '/workflows', label: 'Workflows', icon: SparklesIcon, iconSolid: SparklesIconSolid },
      { href: '/invoices', label: 'Invoices', icon: DocumentTextIcon, iconSolid: DocumentTextIconSolid },
